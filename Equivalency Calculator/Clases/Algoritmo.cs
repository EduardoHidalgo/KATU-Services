...
{
    class Algoritmo : ContenedorPruebas
    {
        ...
        static void Ciclos()
        {
            for (int a = 1; a < MaxPorciones[0]; a++)//GRUPO 1
            {
                ...
                for (int b = 1; b < MaxPorciones[1]; b++)//GRUPO 2
                {
                    ...
                    {
                        Porciones[2] = c;
                        for (int d = 1; d < MaxPorciones[3]; d++)//GRUPO 4
                        {
                            Porciones[3] = d;
                            for (int e = 1; e < MaxPorciones[4]; e++)//GRUPO 5
                            {
                                Porciones[4] = e;
                                for (int f = 1; f < MaxPorciones[5]; f++)//GRUPO 6
                                {
                                    Porciones[5] = 0;
                                    Iteraciones++;
        ...
        {
            Console.Write("{0} ", Porciones[0]);
            Console.Write("{0} ", Porciones[1]);
            Console.Write("{0} ", Porciones[2]);
            Console.Write("{0} ", Porciones[3]);
            Console.Write("{0} ", Porciones[4]);
            Console.WriteLine("{0} ", Porciones[5]);
        }
